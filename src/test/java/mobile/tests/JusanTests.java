...
public class JusanTests extends TestBase {
    ...
    void checkJmartSearchOnMainPageTest() {
        ...
        step("Проверить отображение результатов поиска в Jusan Магазине, помимо результатов в банке", () -> {
            $(xpath("//androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.TextView")).shouldHave(Condition.text("Jusan Магазин"));
        });
    }
